...
export const recruitmentApi = {
    ...
    createRecruitmentRequest: async (requestData: CreateRecruitmentRequest): Promise<CreateRecruitmentResponse> => {
        const { data } = await api.post<CreateRecruitmentResponse>(
            "/api/hr.recruitment.request/create_hr_recruitment_request",
            requestData
        );

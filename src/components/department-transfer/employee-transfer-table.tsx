    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>View all employee transfer requests</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <Table>
                ...
                <TableBody>
                  {transferRequests.map(
                    (request: DepartmentTransferRequest) => (
                      <TableRow key={request.id}>
                        ...
                        <TableCell className="max-w-xs truncate">
                          <span
                            className="text-sm text-muted-foreground"
                            title={request.new_manager_note}
                          >
